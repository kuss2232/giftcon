        ...
        <div class="panel-body">
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
								...
								<tbody>
									<%-- <c:forEach var="faqList" items="${list}" varStatus="stat"> --%>
										...
										<tr class="gradeA even" role="row">
											<td style="text-align: center; vertical-align: middle;">1<%-- ${faqList.FAQ_NUMBER} --%></td>
											<td style="text-align: center; vertical-align: middle;">상품</td>
											<td style="text-align: center; vertical-align: middle;">기프티콘이 사라졌어요</td>
											<td style="text-align: center; vertical-align: middle;">Admin</td>
											<td style="text-align: center; vertical-align: middle;">2019-7-26<%-- <fmt:formatDate value="${faqList.FAQ_REGDATE}" pattern="YY.MM.dd HH:mm" /> --%></td>
					...
					<a href="/giftcon/admin/faqAdminForm"><button type="button" class="btn btn-outline btn-default">등록</button></a>	
				</div>
			</div>
			<!-- /.table-responsive -->
		</div>
