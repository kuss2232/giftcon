...
public class Paginate {
	...
	// 페이징 생성자
	public Paginate(int currentPage, int totalCount, int blockCount, int blockPage, String dogName) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<li><a class='page prv' href=" + dogName + "?currentPage=" + (startPage - 1) + ">");
			pagingHtml.append("&lt;");
		...
		if (totalPage - startPage >= blockPage) {
			pagingHtml.append("<li><a class='page next' href=" + dogName + "?currentPage=" + (endPage + 1) + ">");
			pagingHtml.append("&gt;");
			pagingHtml.append("</a></li>");
		}
	}
	...
	// Search있는 생성자
	public Paginate(int currentPage, int totalCount, int blockCount, int blockPage, String dogName, int searchNum,
			String isSearch) {
